...
import com.jawbone.helloup.utils.PreferenceUtils;
 ...
 * @since 2/13/15.
 */
public class FragmentList extends DefaultFragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        ArrayList<String> listForecast = new ArrayList<>(Arrays.asList(displayStrings));
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<>(
                getActivity(), R.layout.up_api_list, R.id.list_item_text, listForecast);

        apiList.setAdapter(arrayAdapter);

        mAccessToken = PreferenceUtils.getStringPreference(getActivity(), UpPlatformSdkConstants.UP_PLATFORM_ACCESS_TOKEN, null);

        if (mAccessToken != null) {
            ApiManager.getRequestInterceptor().setAccessToken(mAccessToken);
            apiList.setOnItemClickListener(restApiListener());
        }
     ...
     */
    private AdapterView.OnItemClickListener restApiListener() {
        return new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                detailActivityIntent.putExtra(ApiConstants.FRAGMENT_NUM, position);
                switch (apiRequestType) {
                    ...
                    case GET_MOVES_EVENTS_LIST:
                        ...
                        detailActivityIntent.putExtra(ApiConstants.ACTIVITY_TITLE, getString(R.string.moves_event_list));
